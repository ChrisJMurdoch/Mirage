...
public:
    ...
    virtual std::optional<Hit> getHit(Ray const &ray, float tLimit) const = 0;
};
...
public:
    ...
    virtual std::optional<Hit> getHit(Ray const &, float tLimit) const override;
};
...
public:
    ...
    virtual std::optional<Hit> getHit(Ray const &ray, float tLimit) const override;
};
